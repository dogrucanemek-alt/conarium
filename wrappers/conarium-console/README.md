...
Launcher for the `conarium-console` command (open the local console).

```bash
npx conarium-console --help
```

This package contains no logic. It resolves `conarium-console` inside
