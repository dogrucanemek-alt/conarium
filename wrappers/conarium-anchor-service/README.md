# conarium-anchor-service

Launcher for the `conarium-anchor-service` command (submit a chain head for anchoring).

```bash
npx conarium-anchor-service --help
```

This package contains no logic. It resolves `conarium-anchor-service` inside
