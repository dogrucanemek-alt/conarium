...
Launcher for the `conarium-doctor` command (check an installation).

```bash
npx conarium-doctor --help
```

This package contains no logic. It resolves `conarium-doctor` inside
