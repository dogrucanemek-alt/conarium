...
docname: draft-dogru-scitt-disclosure-evidence-03
submissiontype: IETF
number:
date:
consensus: true
...
: The evidence or the Mapping Profile does not determine an outcome — the
  ...
  is undeclared, or the Window's evidence is insufficient to decide.
...
and accounting scope mismatch all produce it. A result statement MUST NOT
...
- Its exit codes predate this vocabulary and are not a mapping of it. They
  ...
  specification look implemented.
...
in 0.2.22 and in this document in this revision.
