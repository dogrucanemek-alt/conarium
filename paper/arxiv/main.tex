...
% The title and the author are written once and read twice: on the title page,
% and in the document information dictionary the PDF carries. A reader who has
% only the file, and every archive that indexes it, sees the second one.
